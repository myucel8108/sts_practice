 ...
 org.springframework.jdbc.datasource.SimpleDriverDataSource; import
 ...
 JdbcTemplate template = new JdbcTemplate(dataSource); List<Menu> list =
 template.query(sql, new BeanPropertyRowMapper(Menu.class)); return list;
 
 }
 
 @Override public Menu findById(long id) {
 
 return null; }
 
 @Override public Menu insert(Menu menu) {
 
 return null; }
 
 @Override public Menu update(Menu menu) {
 ...
 public List<Menu> findAll(Integer offset, Integer page, String query, Integer category){ // TODO Auto-generated method stub return null; }
 
 @Override 
 public List<Menu> findAll(Integer offset, Integer size, String query, Integer category, Integer price, String orderField, String orderDir) {
